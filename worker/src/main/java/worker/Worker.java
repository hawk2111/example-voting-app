...
class Worker {
  public static void main(String[] args) {
    try {
      ...
      Connection dbConn = connectToDB("db", "postgres_user", "postgres_password");
  ...
  static Connection connectToDB(String host, String pgUser, String pgPassword) throws SQLException {
